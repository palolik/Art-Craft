...
const ItemCategoryCrafts = ({ craft }) => {
    // eslint-disable-next-line react/prop-types
    const { average_cost, description, image, rating, customization, short_description, tourists_craft_name } = craft;
    return (
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-2 shadow-2xl p-5 rounded-2xl">
            <img className="col-span-3 rounded-2xl shadow-orange-300" src={image} alt={tourists_craft_name} />
            <div className="col-span-3">
                <h1 className="font-bold text-3xl py-5">{tourists_craft_name}</h1>
...
export default ItemCategoryCrafts;